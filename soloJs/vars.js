   ...
   var brown = {index: 0, name: 'brown' ,  ROIS: [-193.88, 90.2, 800.4 , 2220.79 ], growthScore : 1 , finishedSetValue: 9200 , opacityOnCode: 'rgb(128,0,0)' , opacityOnCode: 'rgb(128,0,0,0.3)' , units : 2};
   ...
   var black = {index: 8, name: 'black' ,  ROIS: [-219.68, 927.19, 3794.38 , 9528.77] ,  growthScore: 1 , finishedSetValue: 8000 ,  opacityOnCode: 'rgb(0,0,0, 0.8)', opacityOffCode:'rgb(0,255,0,0.3)', units : 4};
